    ...
    <>
      <div className="row y-gap-10 justify-between items-center">
        <div className="col-auto">
          ...
          {name === "Children" && (
            <div className="text-14 lh-12 text-light-1 mt-5">나이 0세 - 17세</div>
          )}
        </div>
        {/* End .col-auto */}
        <div className="col-auto">
  ...
  return (
    <div className="searchMenu-guests px-30 lg:py-20 lg:px-0 js-form-dd js-form-counters position-relative">
      <div
        ...
        data-bs-offset="0,22"
      >
        <h4 className="text-15 fw-500 ls-2 lh-16">출발인원</h4>
        <div className="text-15 text-light-1 ls-2 lh-16">
          <span className="js-count-adult">{guestCounts.Adults}</span> 성인 -{" "}
          <span className="js-count-child">{guestCounts.Children}</span>{" "}
          소아 - <span className="js-count-room">{guestCounts.Rooms}</span>{" "}
          room
        </div>
      </div>
      {/* End guest */}
